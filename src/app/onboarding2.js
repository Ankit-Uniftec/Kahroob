...
const Onboading2 = () => {
  const handleNext = () => {
    router.replace(`${Routes.ONBOADRIND3}`);
  };
  ...
  const initialTranslateObj = {
    // set: 'Set',
    alert: 'Classifieds',
    stayinformedText: 'Buy and sell electric vehicles, parts, and accessories easily. Also find the proper service providers for your car repairs, detailing, and installations. Even Insurance!',
    skip: 'Skip',
    next: 'Next',
  };
          ...
          <View style={styles.content}>
            <View style={styles.img}>
              <Image
                ...
                resizeMode='contain'
                source={require('../../assets/onboarding/frame2.png')}
              />
            </View>

            <Text style={styles.title}>{translateObj.set}</Text>
            <Text style={styles.subTitle}>{translateObj.alert}</Text>
            <Text style={styles.txt}>{translateObj.stayinformedText}</Text>
