...
const Onboading4 = () => {
    ...
    const initialTranslateObj = {
        // saveAs: 'Save as',
        favourite: 'Forum',
        saveAsText: 'engage with other EV owners and show off your car or send out an inquiry on our forums and steer up a friendly informative conversation (YES We brought that back!)',
        skip: 'Skip',
        next: 'Next',
    };
