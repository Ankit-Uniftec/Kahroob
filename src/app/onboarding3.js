...
const Onboading3 = () => {
  const handleNext = () => {
    router.replace(`${Routes.ONBOADRIND4}`);
  ...
  const initialTranslateObj = {
    // saveAs: 'Save as',
    favourite: 'Community',
    saveAsText: 'Be a part of our communities and help up maintain an accurate list of the charging stations. Report new locations or operational locations.',
    skip: 'Skip',
    next: 'Next',
  };
          ...
          <View style={styles.content}>
            <View style={styles.img}>
              <Image
                ...
                resizeMode='contain'
                source={require('../../assets/onboarding/frame3.png')}
              />
            </View>

            <Text style={styles.title}>{translateObj.saveAs}</Text>
            <Text style={styles.subTitle}>{translateObj.favourite}</Text>
            <Text style={styles.txt}>{translateObj.saveAsText}</Text>
